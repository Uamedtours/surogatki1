...
$column_classes = modelicom_get_columns_classes(true);
...
<section class="<?php echo esc_attr( $options['version'] ); ?> page_portfolio s-pt-100 s-pb-75 c-gutter-60">
...
<?php endif; ?>
	<div id="content" class="<?php echo esc_attr( $column_classes['main_column_class'] ); ?>">
		<?php if ( have_posts() ) :
			...
			esc_html_e( 'No items it category ', 'modelicom' );
		    echo wp_kses_post('<strong>' . $queried_object->name . '</strong>' );
		endif;
		?>
