...
$options = array(
	...
	'items'         => array(
		...
		'box-options'     => array(
			'image' => array(
				'type'        => 'upload',
				'value'       => '',
				'label'       => esc_html__( 'Image', 'modelicom' ),
				'images_only' => true,
			),
			'url'   => array(
				'type'  => 'text',
			...
			'lightbox' => array(
				'type'         => 'switch',
				'value'        => false,
				'label'        => esc_html__( 'Open link in lightbox', 'modelicom' ),
				'desc'         => esc_html__( 'If your link is a video link you can open it in lightbox', 'modelicom' ),
				'right-choice' => array(
					'value' => true,
			...
			'title' => array(
				'type'  => 'text',
				'value' => '',
				'label' => esc_html__( 'Title and Alt text', 'modelicom' ),
			),
		),
		'template'        => '{{=image.url}}',
	...
	'nav'           => array(
		'type'         => 'switch',
		'value'        => 'false',
		'label'        => esc_html__( 'Show Arrows', 'modelicom' ),
		'left-choice'  => array(
			'value' => 'false',
			'label' => esc_html__( 'No', 'modelicom' ),
		),
