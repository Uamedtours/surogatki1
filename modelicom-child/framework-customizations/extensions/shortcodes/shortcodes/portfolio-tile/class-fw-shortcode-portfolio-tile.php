...
class FW_Shortcode_Portfolio_Tile extends FW_Shortcode {
	...
	public static function add_portfolio_tile_image_sizes() {
		add_image_size( 'modelicom-portfolio-shortcode-tile-square', 750, 510, true );
		add_image_size( 'modelicom-portfolio-shortcode-tile-half-square-horizontal',800,  1150, true );
	}
