				...
				<div class="item-content">
					<header class="entry-header">
						...
						<div class="hero-bg post-adds">
							<?php
							modelicom_share_this();
							modelicom_post_like_button( get_the_ID() );
							modelicom_post_like_count( get_the_ID() );
							?>
					...
					<div class="entry-content">
						...
						<div class="event-info">
							<p class="event-place">
								...
								if ( $options['event_location']['location'] ) : ?>
									<strong class="grey"><?php esc_html_e( 'Place', 'modelicom' ) ?>:</strong>
									<?php
							...
							foreach ( $options['event_children'] as $key => $row ) : ?>
								...
								<div class="pull-right">
									<button class="btn btn-maincolor small_button"
											...
											'modelicom' ) ?></button>
									<button class="btn btn-maincolor small_button" data-uri="<?php echo add_query_arg( array(
										'row_id'   => $key,
										'calendar' => 'ical'
								...
								<ul class="list-unstyled">
									<li><strong class="grey"><?php esc_html_e( 'Start', 'modelicom' ) ?>
											:</strong> <?php echo wp_kses_post ( $row['event_date_range']['from'] ); ?></li>
									<li><strong class="grey"><?php esc_html_e( 'End', 'modelicom' ) ?>
						...
						modelicom_fw_releted_events();
						?>

						<?php do_action( 'modelicom_ext_events_after_content' ); ?>
					</div><!-- .entry-content -->
				</div><!-- .item-content -->
			</article>
